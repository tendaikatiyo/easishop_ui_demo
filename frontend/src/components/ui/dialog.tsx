  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed top-1/2 left-1/2 z-50 grid w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-5 rounded-[32px] bg-white p-6 text-sm text-foreground shadow-xl outline-none sm:max-w-md",
          ...
          <DialogPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                size="icon"
                className="absolute top-4 right-4 z-20 size-9 rounded-full text-black hover:bg-zinc-100"
              />
            }
          >

    ...
    <div className="space-y-6 animate-rise">
      ...
      <div className="md:hidden space-y-5">
        <div className="flex gap-3">
          <div className="relative size-20 shrink-0 overflow-hidden rounded-lg border border-hairline bg-surface-warm">
            <Image
              src={product.image}
              alt={product.name}
              fill
          ...
          <div className="min-w-0 flex-1">
            ...
            {lowest ? (
              <p className="mt-1 text-sm">
                ...
                <span className="text-mute"> lowest at {lowest.retailer}</span>
              </p>
            ) : null}
          </div>
        </div>
      ...
      <div className="hidden gap-8 md:grid md:grid-cols-[280px_1fr]">
        <div className="space-y-3">
          <div className="relative aspect-square overflow-hidden rounded-xl border border-hairline bg-surface-warm">
            <Image
              src={product.image}
              alt={product.name}
              fill
          ...
          <div className="flex items-start justify-between gap-2">
            <div>
              ...
              <p className="mt-1 text-sm text-mute">{product.category}</p>
            </div>
